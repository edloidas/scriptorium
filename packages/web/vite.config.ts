...
// Node 22+ emits a warning when --localstorage-file is passed without a valid path
// by the jsdom environment in Vitest. Suppress it by propagating --no-warnings to workers.
